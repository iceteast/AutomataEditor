...
function App() {
  ...
  const handleModelChange = (obj: go.IncrementalData) => {
    ...
    // skipsDiagramUpdate = true;  // the GoJS model already knows about these updates
...
//     // const [singleMultiple, setSingleMultiple] = React.useState<string>('single');
